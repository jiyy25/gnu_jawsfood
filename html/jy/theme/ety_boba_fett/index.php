...
<?php echo latest('pic_block','swiper_main',3, 100) ?>



<?php echo latest('sns','jaws_comubanner',10,200); ?>
...
<!-- 이 안의 태그를 youtube 스킨의 for문으로 반드시 넣어주시고 -->
<!-- 값이 들어가는 echo문으로 연동하기 -->
<?php echo latest('utub','main_utub',1,200); ?>
